...
export class TableComponent implements OnInit {
  ...
  constructor(private messageService : MessageService, private confirmationService : ConfirmationService) { this.types=[
    'Incident',
    'Trading Account',
  ...
  deleteProduct(data: DataTableModel) {
    this.confirmationService.confirm({
        message: 'Are you sure you want to delete the request ' + data.type + ' of ' + data.dateOfRequest + '?',
        header: 'Confirm',
