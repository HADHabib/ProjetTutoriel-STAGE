...
export class ReactiveformComponent implements OnInit {
  ...
  profileForm = new FormGroup({
    ...
    Temp: new FormControl('',  [Validators.required, Validators.pattern(/^-?(0|[1-9]\d*)?$/)]),
    FeelsLike: new FormControl('', [Validators.required, Validators.pattern(/^-?(0|[1-9]\d*)?$/)]),
    Humidity: new FormControl('', [Validators.required, Validators.pattern(/^-?(0|[1-9]\d*)?$/), Validators.min(0), Validators.max(100)]),
  });
