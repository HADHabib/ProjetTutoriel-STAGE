...
export class IncidentNumberComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.incidentnumberpart1=this.incidentInput.numberIncident.toString().substring(0,4);
    this.incidentnumberpart2=this.incidentInput.numberIncident.toString();
    this.incidentnumberpart2=this.incidentnumberpart2.substring(4,this.incidentnumberpart2.length);
  }
